...
docker run -t -d --name zookeeper -p 2181:2181 -v D:/code/docker/volume/zookeeper/conf:/conf -v D:/code/docker/volume/zookeeper/data:/data -v D:/code/docker/volume/zookeeper/datalog:/datalog zookeeper:3.4.10
...
docker run -t -d --name nginx -p 80:80 -p 443:443 -v D:/code/docker/volume/nginx/conf.d:/etc/nginx/conf.d -v D:/code/docker/volume/nginx/static:/etc/nginx/static -v D:/code/docker/volume/nginx/cert:/etc/nginx/cert nginx:1.8.1

docker run -t -d --name mongo -p 27017:27017 -v D:/code/docker/volume/mongo/data:/data mongo:3.6.3

docker run -t -d --name rabbitmq --hostname rabbitmq -p 5672:5672 -p 15672:15672 -v D:/code/docker/volume/rabbitmq/config:/etc/rabbitmq -v D:/code/docker/volume/rabbitmq/database:/var/lib/rabbitmq/mnesia/rabbit@rabbitmq rabbitmq:3.6.9-management
